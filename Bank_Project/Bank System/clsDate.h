...
public:
	...
	static string GetSystemDateTimeString()
	{
		...
		short Day, Month, Year, Hours, Minute, Second;
		...
		return  to_string(Day) + "/" + to_string(Month) + "/" + to_string(Year)
			+ " - " + to_string(Hours) + ":" + to_string(Minute) + ":" + to_string(Second);
	...
	static bool IsDateAfterDate(clsDate Date, clsDate Date1)
	{
		return Date._Year <= Date1._Year && Date._Month <= Date1._Month && Date._Day < Date1._Day;
